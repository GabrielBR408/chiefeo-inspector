...
import { track, isInternal, APP_TAG } from '../lib/track.js'
...
// be tied to the exact deployed build. Esc closes; focus starts in the
// textarea and returns to the pill on close.
const TYPES = [
          ...
          <div className="fb-sheet" role="dialog" aria-modal="true" aria-label="Send feedback" onClick={(e) => e.stopPropagation()}>
            {status === 'sent' ? (
              <div className="fb-done" role="status">
                ...
                <p className="fb-done-note">Your report was tagged to v{APP_VERSION} · {COMMIT_SHA}.</p>
              ...
              <>
                ...
                <div className="fb-receipt">
                  ...
                  <span>{APP_TAG} · v{APP_VERSION} · {COMMIT_SHA} · screen: {screen}</span>
                </div>
