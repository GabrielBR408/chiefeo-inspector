...
// file has sibling copies in variance-narrative-generator and
// owner-report-generator. Edits here do not propagate — keep the copies in
// sync by hand.
//
// Informational ONLY. It never gates the action it sits next to: drafting runs
